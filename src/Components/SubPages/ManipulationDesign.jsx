...
const ManipulationDesign = () => {
  ...
  useEffect(() => {
    const loadImages = async () => {
      try {
        const data = await fetchUploadsByCategory("manipulation");
        setImages(data);
      } catch (fetchError) {
        setError(fetchError.message || "Failed to load manipulation designs.");
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <div className="text-white px-6 pb-20">
      <div className="max-w-7xl mx-auto text-center mb-16">
        ...
        >
          Creative photo manipulation to bring bold ideas to life.
        </motion.p>
      </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {!loading && !error && images.length === 0 && (
          <p className="text-center text-gray-400">No manipulation design uploaded yet.</p>
        )}
